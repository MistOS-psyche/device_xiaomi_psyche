...
git clone https://github.com/Infinity-X-Devices/android_hardware_xiaomi.git -b 16.0 hardware/xiaomi

# Clone the kernel source
echo "Cloning kernel repository..."
git clone https://github.com/MistOS-psyche/kernel_xiaomi_sm8250.git -b aosp-16 kernel/xiaomi/sm8250
